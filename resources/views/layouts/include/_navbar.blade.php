...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="container-fluid">
        ...
        @if(request()->segment(1)=='siswa')
            <form class="navbar-form navbar-left" method="GET" action="{{route('siswa.index')}}">
        @endif
        @if(request()->segment(1)=='guru')
            <form class="navbar-form navbar-left" method="GET" action="{{route('guru.index')}}">
        @endif
        @if(request()->segment(1)=='buku')
            <form class="navbar-form navbar-left" method="GET" action="{{route('buku.index')}}">
        @endif
        ...
        <div id="navbar-menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="{{asset('admin/assets/img/user.png')}}" class="img-circle" alt="Avatar"> <span>Nama Admin</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
                    <ul class="dropdown-menu">
